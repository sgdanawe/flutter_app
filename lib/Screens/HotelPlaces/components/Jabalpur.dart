      ...
      Container(
        child: ListView(
          ...
          children: [
            ...
            travelCard(urls[0], "Luxary Hotel", "P1", 3),
            travelCard(urls[5], "Plaza Hotel", "P2", 4),
            travelCard(urls[2], "Safari Hotel", "P3", 5),
            travelCard(urls[5], "Plaza Hotel", "P4", 4),
          ],
        ),
      ),
      Container(
        child: ListView(
          ...
          children: [
            ...
            travelCard(urls[6], "Visit Dhuadhar", "Tilwara", 4),
            travelCard(urls[8], "Visit RD Musuem", "Civic centre", 4),
          ],
        ),
      ),
    ],
